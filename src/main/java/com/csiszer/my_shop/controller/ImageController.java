...
import com.csiszer.my_shop.service.image.IImageService;
...
public class ImageController {
    ...
    public ResponseEntity<ApiResponse> updatesImage(@PathVariable Long imageId, @RequestBody MultipartFile file) {
        try {
            Image image = imageService.getImageById(imageId);
            if (image != null) {
